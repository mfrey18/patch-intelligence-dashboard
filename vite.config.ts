...
const publicDashboardOrigins = process.env.PUBLIC_DASHBOARD_ORIGINS;
...
const localBindingConfig = {
  name: "patch-intelligence-api",
  main: "./worker/index.ts",
  compatibility_date: "2026-05-22",
  compatibility_flags: ["nodejs_compat"],
  vars: publicDashboardOrigins ? { PUBLIC_DASHBOARD_ORIGINS: publicDashboardOrigins } : undefined,
  d1_databases: d1
    ? [
        {
          binding: d1,
