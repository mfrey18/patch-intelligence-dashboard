...
export const CHANGE_TYPES = [
  "NEW_ADVISORY", "NEW_CVE", "ADVISORY_REVISED", "SEVERITY_CHANGED", "CVSS_CHANGED", "EXPLOITATION_STATUS_CHANGED", "KEV_ADDED", "KEV_REMOVED", "KEV_DEADLINE_CHANGED", "KEV_ENTRY_MODIFIED", "AFFECTED_PRODUCT_ADDED", "AFFECTED_PRODUCT_REMOVED", "FIXED_VERSION_CHANGED", "REMEDIATION_CHANGED", "MITIGATION_ADDED", "WORKAROUND_ADDED", "SOURCE_MODIFIED",
] as const;
