...
export interface CveDetailResponse {
  ...
  remediations: Array<{ advisoryId: string; sourceId: string; observedAt: string; vendor: string; products: string[]; kind: string; patchAvailable: boolean | null; fixedVersion: string | null; action: string | null; rebootRequired: boolean | null; superseded: boolean | null; sourceUrl: string; publishedAt: string | null; updatedAt: string | null }>;
